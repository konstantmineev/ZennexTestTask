    ...
    public void onClick(DialogInterface dialogInterface, int i) {
        ...
        switch (i) {
            case Dialog.BUTTON_POSITIVE:
                try {
                    ((ListFragment) getFragmentManager().findFragmentByTag(LIST_FRAGMENT_TAG)).editItem(input.getText().toString(), positionItem);
            ...
            alertDialog.setTitle(R.string.new_title_was_not_saved)
                    ...
                    .setPositiveButton(R.string.save, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int arg1) {
                            try {
                                listFragment.editItem(input.getText().toString(), positionItem);
